...
const getPostComments = async (req, res) => {
  ...
  let queryObject = { _id: req.params.postId };
...
const getUserCommentsOnPost = async (req, res) => {
    // No time for pagination get
    let queryObject = { _id: req.params.postId, user:req.user.userId };
    const sort = "-updatedAt";
...
module.exports = { getPostComments, getUserCommentsOnPost, comment, updateComment, deleteComment };
